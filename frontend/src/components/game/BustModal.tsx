...
export default function BustModal({ gameId, playerName, isMe, send }: Props) {
      ...
      <div className="w-full max-w-sm bg-gray-900 border border-gray-700 rounded-2xl p-6 space-y-5">
        <div className="text-center">
          ...
          <h2 className="text-xl font-bold text-white">
            {isMe ? "You're out of chips!" : `${playerName} is out of chips`}
          </h2>
          <p className="text-sm text-gray-400 mt-1">
            {isMe ? 'Add more to keep playing or end the game.' : `Waiting for ${playerName} to add chips or end the game.`}
          </p>
        </div>
